...
describe('ZipDiff', function(done) {
	...
	it('should produce a diff with an extra file', function () {
	...
	it('should produce a diff with updated files', function () {
	...
	it('should produce a diff with extra files', function () {
	...
	it('should produce a diff with complicated file structure', function () {
